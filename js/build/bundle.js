...
var popup = {
  ...
  init: function () {
    ...
    this.customers = this.getCustomerCache();
  ...
  */
  populateCustomerData: function () {
    ...
    this.setCustomerAsHandled(customerId);
    this.updateCustomerOptionsDOM(this.customers);
  },
  ...
  */
  ...
  setCustomerAsHandled: function (id) {
    ...
    localStorage.customers = this.customers;
  },
